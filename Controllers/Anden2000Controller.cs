...
{
    public class Anden2000Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Anden2000Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var query = _context.Anden2000.AsQueryable();
        ...
        {
            var contenedor = _context.Anden2000.FirstOrDefault(c => c.Id == id);
        ...
        // ===============================
        // MOVER DESDE ANDÉN 2000
        // ===============================
        [HttpPost]
        public IActionResult MoverDesdeAnden2000(int id, string destino)
        {
            var contenedor = _context.Anden2000.FirstOrDefault(c => c.Id == id);
            ...
            _context.Anden2000.Remove(contenedor);
            _context.SaveChanges();
        ...
        {
            var contenedores = _context.Anden2000.ToList();
            ...
            _context.Anden2000.RemoveRange(contenedores);
            _context.SaveChanges();
        ...
        public IActionResult ExportarPDF(string nombre, DateTime fecha, string turno)
        {
            ...
            var pdf = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    {
                        // 🔹 SOLO SALE UNA VEZ (primera página)
            ...
            return File(pdf, "application/pdf",
                $"Inventario_Anden2000_{DateTime.Now:dd-MM-yyyy}_Turno_{turno}.pdf");
        ...
        public IActionResult ExportarExcel(string nombre, DateTime fecha, string turno)
        {
            ...
            ws.Cell("A3").Value = "INVENTARIO OFICIAL – ANDÉN 2000";
            ...
            return File(stream.ToArray(),
                ...
                $"Inventario_Anden2000_{DateTime.Now:dd-MM-yyyy}_Turno_{turno}.xlsx");
        }
        ...
        public IActionResult GuardarOrden([FromBody] List<OrdenItem> lista)
        {
            ...
            var contenedores = _context.Anden2000
